...
>(
  (
    ...
    const button = asChild && React.isValidElement(children) ? (
      React.cloneElement(children as React.ReactElement<any>, buttonProps)
    ) : (
      <button {...buttonProps}>
        {children}
      </button>
...
>(({ className, asChild = false, showOnHover = false, children, ...props }, ref) => {
  ...
  if (asChild && React.isValidElement(children)) {
    return React.cloneElement(children as React.ReactElement<any>, buttonProps)
  }
...
>(({ asChild = false, size = "md", isActive, className, children, ...props }, ref) => {
  ...
  if (asChild && React.isValidElement(children)) {
    return React.cloneElement(children as React.ReactElement<any>, linkProps)
  }
